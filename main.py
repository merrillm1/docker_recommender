...
def select_user_and_recommend():
	...
	likes = recom.known_likes(sl)
	result = recom.recommendation_for_user(sl, user_features=user_to_feature_interaction)
	
	return 'For user ID \n' + str(sl) + ' who likes items in the ' + str(likes) + \
